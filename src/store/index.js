...
errorMessage: '',
  ...
  settings: {
    ...
    apiUrl: '',
    authToken: '',
    strIncomeItems: 'ベラジョン,カジ旅,レオベガス,エルドア,ビットカジノ,プレイアモ,10BET,ワンダー,188BET,ミスティーノ,ゴッズ',
    strOutgoItems: 'ベラジョン,カジ旅,レオベガス,エルドア,ビットカジノ,プレイアモ,10BET,ワンダー,188BET,ミスティーノ,ゴッズ',
